...
# This is the default value. The final value will be determine from the cpu_count (see below).
THREAD_NUMBER : int = 1

# Variable OPENMP (True | False)
# Set the multiprocessing capability for the CPU shaders.
# When the variable is set to False, the Cielab will work on a single thread.
